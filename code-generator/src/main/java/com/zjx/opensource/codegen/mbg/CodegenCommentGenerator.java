...
//        javaElement.addJavaDocLine(" *"); //$NON-NLS-1$
        ...
        sb.append(MergeConstants.NEW_ELEMENT_TAG);
        if (markAsDoNotDelete) {
            sb.append(" eclipse插件识别是否覆盖的注解"); //$NON-NLS-1$
        }
        String s = getDateString();
        if (s != null) {
            sb.append(' ');
...
//        innerEnum.addJavaDocLine(" * This enum was generated by MyBatis Generator."); //$NON-NLS-1$
        ...
        sb.append(" * 这个枚举对应数据库表: "); //$NON-NLS-1$
        sb.append(introspectedTable.getFullyQualifiedTable());
...
//                .addJavaDocLine(" * This method was generated by MyBatis Generator."); //$NON-NLS-1$
        ...
        sb.append(" * 返回值对应数据库表字段:  "); //$NON-NLS-1$
        sb.append(introspectedTable.getFullyQualifiedTable());
        sb.append('.');
        sb.append(introspectedColumn.getActualColumnName());
        method.addJavaDocLine(sb.toString());
...
//                .addJavaDocLine(" * This method was generated by MyBatis Generator."); //$NON-NLS-1$
        ...
        sb.append(" * 给对应数据库表字段设值：  "); //$NON-NLS-1$
        sb.append(introspectedTable.getFullyQualifiedTable());
        sb.append('.');
        sb.append(introspectedColumn.getActualColumnName());
        method.addJavaDocLine(sb.toString());
